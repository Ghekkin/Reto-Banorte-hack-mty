...
|---|---|---|---|
| **H6** | sáb 02:00 | Spike A2UI decidido: renderer oficial o processor propio (ADR 0003) | Processor propio, sin discutir más |
