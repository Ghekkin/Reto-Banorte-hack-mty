...
| 2026-09-13 | alta | infra | [El commit y push automáticos de `CLAUDE.md` no corren: `.claude/settings.json` no trae hooks](2026-09-13-hooks-de-sync-no-estan-configurados.md) | [#22](https://github.com/Ghekkin/Reto-Banorte-hack-mty/issues/22) | abierto |
...
| 2026-09-13 | media | mcp | [La hipoteca de Carmen tiene pagos vencidos pero `dias_mora: 0` y `estatus: vigente`](2026-09-13-hipoteca-carmen-vencida-sin-mora.md) | [#24](https://github.com/Ghekkin/Reto-Banorte-hack-mty/issues/24) | abierto |
| 2026-09-13 | media | mcp | [`simular_reestructura` y `aplicar_plan_pago` comparan la mensualidad del plan contra lo LIBRE de buró, sin sumar el mínimo que el plan reemplaza](2026-09-13-capacidad-de-pago-contra-mensualidad-del-plan.md) | [#25](https://github.com/Ghekkin/Reto-Banorte-hack-mty/issues/25) | abierto |
| 2026-09-13 | alta | web | [La dona de `DistribucionPortafolio` como héroe pinta invisibles las clases de la sexta en adelante](2026-09-13-dona-heroe-segmentos-invisibles.md) | [#26](https://github.com/Ghekkin/Reto-Banorte-hack-mty/issues/26) | abierto |
...
| 2026-09-13 | media | web | [«Disponible» suma la cuenta de inversión: a Carmen le marca $3,543,842 cuando lo líquido es $669,342](2026-09-13-disponible-suma-la-cuenta-de-inversion.md) | [#32](https://github.com/Ghekkin/Reto-Banorte-hack-mty/issues/32) | abierto |
...
| 2026-09-13 | media | web | [8 de cada 10 portadas con widgets vivos pagan dos peticiones: la primera cita una tarjeta que no pintó](2026-09-13-portada-rechazada-por-cifra-de-tarjeta-ausente.md) | [#34](https://github.com/Ghekkin/Reto-Banorte-hack-mty/issues/34) | **abierto** (a medias en `36a1c09`) |
| 2026-09-13 | media | web | [Las preguntas a una tarjeta de Inicio (widgets vivos) no dejan corrida ni tokens en la base](2026-09-13-preguntas-a-widgets-sin-corrida-ni-tokens.md) | [#35](https://github.com/Ghekkin/Reto-Banorte-hack-mty/issues/35) | abierto |
| 2026-09-13 | media | web | [En `next dev`, el reloj de portadas sigue corriendo el código de cuando arrancó el servidor y pisa las portadas de la base compartida](2026-09-13-reloj-de-portadas-con-codigo-viejo-en-dev.md) | [#38](https://github.com/Ghekkin/Reto-Banorte-hack-mty/issues/38) | abierto |
| 2026-09-13 | media | web | [Desde 6cefc30, un visitante nuevo ve la portada común aunque se armó con las acciones de otro](2026-09-13-visitante-nuevo-ve-portada-con-acciones-ajenas.md) | [#37](https://github.com/Ghekkin/Reto-Banorte-hack-mty/issues/37) | abierto |
