...
| 2026-09-12 | crítica | infra | [La demo está caída: el proyecto de Gemini pasó su tope de gasto mensual](2026-09-12-gemini-sin-cuota.md) | [#12](https://github.com/Ghekkin/Reto-Banorte-hack-mty/issues/12) | **abierto** (se volvió a agotar sáb 18:53) |
| 2026-09-12 | baja | docs | [Los docs fechan el trabajo del sábado como 2026-09-13](2026-09-12-fechas-de-docs-un-dia-adelante.md) | pendiente (sin `gh`) | abierto |
...
| 2026-09-12 | alta | web | [El agente confirma un rebalanceo que nunca se ejecutó: seis widgets disparan acciones que ninguna tool atiende](2026-09-12-agente-confirma-rebalanceo-que-no-existe.md) | [#16](https://github.com/Ghekkin/Reto-Banorte-hack-mty/issues/16) | abierto |
| 2026-09-12 | alta | web | [El modelo formateaba el dinero a mano en `Conclusion` y llegó a pantalla `$457,09.50`](2026-09-12-conclusion-formatea-dinero-a-mano.md) | pendiente (sin `gh`) | resuelto |
| 2026-09-12 | alta | web | [`revisarProps` se saltaba las props enlazadas, y el modelo enlaza casi todo](2026-09-12-props-enlazadas-sin-validar.md) | pendiente (sin `gh`) | resuelto |
| 2026-09-12 | alta | mcp | [Había componentes del catálogo cuyas cifras ninguna tool calculaba, y el modelo las inventaba](2026-09-12-cifras-sin-tool-que-las-calcule.md) | pendiente (sin `gh`) | resuelto |
| 2026-09-12 | media | web | [`SimuladorMeta` pintó una aportación por debajo de su propio piso](2026-09-12-simulador-meta-aportacion-fuera-de-rango.md) | pendiente (sin `gh`) | resuelto |
| 2026-09-12 | baja | mcp | [Parámetros que existían en el dominio y no estaban conectados](2026-09-12-parametros-declarados-sin-conectar.md) | pendiente (sin `gh`) | resuelto |
| 2026-09-12 | media | web | [Un turno perdió una tarjeta y le mostró a la persona un aviso de renderer](2026-09-12-aviso-de-renderer-en-la-conversacion.md) | pendiente (sin `gh`) | **abierto** |
| 2026-09-13 | crítica | infra | [Un `Revert "."` borró el trabajo de dos sesiones a la vez](2026-09-13-revert-punto-se-llevo-trabajo-ajeno.md) | pendiente (sin `gh`) | resuelto (recuperado), causa abierta |
