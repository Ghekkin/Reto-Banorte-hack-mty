...
| 2026-09-13 | alta | web | [`pantalla.ts` rellena las props que el modelo omite con cifras inventadas (saldo $47,386, mensualidad $5,500, 27.9 %)](2026-09-13-pantalla-rellena-cifras-inventadas.md) | [#23](https://github.com/Ghekkin/Reto-Banorte-hack-mty/issues/23) | abierto |
...
| 2026-09-13 | alta | web | [La tarjeta de Inicio dice `ÔÇóÔÇóÔÇóÔÇó 4821` en vez de `•••• 4821`](2026-09-13-mascara-de-tarjeta-con-mojibake.md) | [#28](https://github.com/Ghekkin/Reto-Banorte-hack-mty/issues/28) | abierto |
...
| 2026-09-13 | alta | web | [`normalizarListaDeComponentes` sigue tratando bindings legítimos como datos faltantes en otros componentes](2026-09-13-normalizacion-destruye-bindings-legitimos.md) | [#39](https://github.com/Ghekkin/Reto-Banorte-hack-mty/issues/39) | abierto |
| 2026-09-13 | alta | web | [`AvisoConsultaNoValida` nunca pinta: el host le agrega `motivo` y `sugerencias`, que su schema no tiene](2026-09-13-aviso-consulta-no-valida-siempre-rechazado.md) | [#40](https://github.com/Ghekkin/Reto-Banorte-hack-mty/issues/40) | abierto |
