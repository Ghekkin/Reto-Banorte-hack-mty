...
| 2026-09-13 | baja | web | [`quitarPropsNoDeclaradas` deja `salud` en `Conclusion` porque se parece a `saludo`, y la pantalla se rechaza una vez](2026-09-13-prop-parecida-no-se-quita.md) | [#46](https://github.com/Ghekkin/Reto-Banorte-hack-mty/issues/46) | abierto |
