...
| 2026-09-13 | media | web | [`ProyeccionCrecimiento` le dice al modelo que ya llamó `proyectar_inversion`, una tool que no existe en `main`](2026-09-13-proyeccion-crecimiento-sin-tool.md) | [#19](https://github.com/Ghekkin/Reto-Banorte-hack-mty/issues/19) | resuelto (`aebeb47`) |
| 2026-09-13 | baja | web | [El `Spinner` anuncia "Loading" en inglés en los botones de enviar](2026-09-13-spinner-anuncia-loading-en-ingles.md) | [#20](https://github.com/Ghekkin/Reto-Banorte-hack-mty/issues/20) | resuelto (`f1bdbf0`) |
...
| 2026-09-13 | alta | infra | [El commit y push automáticos de `CLAUDE.md` no corren: `.claude/settings.json` no trae hooks](2026-09-13-hooks-de-sync-no-estan-configurados.md) | [#22](https://github.com/Ghekkin/Reto-Banorte-hack-mty/issues/22) | descartado (el equipo ya no desarrolla) |
| 2026-09-13 | alta | web | [En `/maya` (y en Inicio sin widgets vivos) las cifras de las tarjetas las escribe el modelo y nadie las contrasta con el MCP](2026-09-13-cifras-escritas-por-el-modelo-en-maya.md) | pendiente (sin `gh`) | **abierto** (resuelto en Inicio con widgets vivos, ADR 0011) |
| 2026-09-13 | alta | web | [`pantalla.ts` rellena las props que el modelo omite con cifras inventadas (saldo $47,386, mensualidad $5,500, 27.9 %)](2026-09-13-pantalla-rellena-cifras-inventadas.md) | [#23](https://github.com/Ghekkin/Reto-Banorte-hack-mty/issues/23) | resuelto (`8060918`) |
| 2026-09-13 | media | mcp | [La hipoteca de Carmen tiene pagos vencidos pero `dias_mora: 0` y `estatus: vigente`](2026-09-13-hipoteca-carmen-vencida-sin-mora.md) | [#24](https://github.com/Ghekkin/Reto-Banorte-hack-mty/issues/24) | resuelto (`cc1dbfb`) |
| 2026-09-13 | media | mcp | [`simular_reestructura` y `aplicar_plan_pago` comparan la mensualidad del plan contra lo LIBRE de buró, sin sumar el mínimo que el plan reemplaza](2026-09-13-capacidad-de-pago-contra-mensualidad-del-plan.md) | [#25](https://github.com/Ghekkin/Reto-Banorte-hack-mty/issues/25) | resuelto (`e6f4b43`) |
| 2026-09-13 | alta | web | [La dona de `DistribucionPortafolio` como héroe pinta invisibles las clases de la sexta en adelante](2026-09-13-dona-heroe-segmentos-invisibles.md) | [#26](https://github.com/Ghekkin/Reto-Banorte-hack-mty/issues/26) | resuelto (`cb2d8dc`) |
| 2026-09-13 | media | web | [Con widgets vivos, la pregunta hecha en la barra de Inicio se guarda sin procedencias y el siguiente render la tira](2026-09-13-pregunta-en-inicio-sin-procedencias.md) | [#27](https://github.com/Ghekkin/Reto-Banorte-hack-mty/issues/27) | resuelto |
| 2026-09-13 | alta | web | [La tarjeta de Inicio dice `ÔÇóÔÇóÔÇóÔÇó 4821` en vez de `•••• 4821`](2026-09-13-mascara-de-tarjeta-con-mojibake.md) | [#28](https://github.com/Ghekkin/Reto-Banorte-hack-mty/issues/28) | resuelto (`8060918`) |
| 2026-09-13 | media | infra | [El commit por rutas en el árbol compartido se lleva cambios de otra sesión](2026-09-13-commit-por-rutas-se-lleva-cambios-ajenos.md) | [#31](https://github.com/Ghekkin/Reto-Banorte-hack-mty/issues/31) | resuelto |
| 2026-09-13 | crítica | web | [`main` roto: los componentes del catálogo importan `transicion.ts`, que no se commiteó](2026-09-13-main-roto-transicion-sin-commitear.md) | [#30](https://github.com/Ghekkin/Reto-Banorte-hack-mty/issues/30) | resuelto |
| 2026-09-13 | critica | web | [`main` no arranca: el catálogo importa `./transicion`, que nunca se subió](2026-09-13-transicion-sin-commitear-rompe-ci.md) | [#29](https://github.com/Ghekkin/Reto-Banorte-hack-mty/issues/29) | descartado (duplicado de #30) |
| 2026-09-13 | media | web | [«Disponible» suma la cuenta de inversión: a Carmen le marca $3,543,842 cuando lo líquido es $669,342](2026-09-13-disponible-suma-la-cuenta-de-inversion.md) | [#32](https://github.com/Ghekkin/Reto-Banorte-hack-mty/issues/32) | resuelto (`b2650f4`) |
| 2026-09-13 | alta | web | [Si el estado común tiene una acción, cada visitante nuevo paga su propia portada de Inicio](2026-09-13-portada-pagada-por-cada-visitante-nuevo.md) | [#33](https://github.com/Ghekkin/Reto-Banorte-hack-mty/issues/33) | resuelto (`6cefc30`) |
| 2026-09-13 | media | web | [8 de cada 10 portadas con widgets vivos pagan dos peticiones: la primera cita una tarjeta que no pintó](2026-09-13-portada-rechazada-por-cifra-de-tarjeta-ausente.md) | [#34](https://github.com/Ghekkin/Reto-Banorte-hack-mty/issues/34) | resuelto (`e4ca8e7`) |
| 2026-09-13 | media | web | [Las preguntas a una tarjeta de Inicio (widgets vivos) no dejan corrida ni tokens en la base](2026-09-13-preguntas-a-widgets-sin-corrida-ni-tokens.md) | [#35](https://github.com/Ghekkin/Reto-Banorte-hack-mty/issues/35) | resuelto (`2ec5df4`) |
| 2026-09-13 | media | web | [En `next dev`, el reloj de portadas sigue corriendo el código de cuando arrancó el servidor y pisa las portadas de la base compartida](2026-09-13-reloj-de-portadas-con-codigo-viejo-en-dev.md) | [#38](https://github.com/Ghekkin/Reto-Banorte-hack-mty/issues/38) | resuelto (`1218e6d`) |
| 2026-09-13 | media | web | [Desde 6cefc30, un visitante nuevo ve la portada común aunque se armó con las acciones de otro](2026-09-13-visitante-nuevo-ve-portada-con-acciones-ajenas.md) | [#37](https://github.com/Ghekkin/Reto-Banorte-hack-mty/issues/37) | resuelto (`fd73cb9`) |
| 2026-09-13 | alta | web | [`normalizarListaDeComponentes` sigue tratando bindings legítimos como datos faltantes en otros componentes](2026-09-13-normalizacion-destruye-bindings-legitimos.md) | [#39](https://github.com/Ghekkin/Reto-Banorte-hack-mty/issues/39) | resuelto (`8060918`) |
| 2026-09-13 | alta | web | [`AvisoConsultaNoValida` nunca pinta: el host le agrega `motivo` y `sugerencias`, que su schema no tiene](2026-09-13-aviso-consulta-no-valida-siempre-rechazado.md) | [#40](https://github.com/Ghekkin/Reto-Banorte-hack-mty/issues/40) | resuelto (`8060918`) |
| 2026-09-13 | media | web | [`orientar_consulta_no_valida` devuelve `tipoInvalidez: incompatible_con_politica`, que `AvisoConsultaNoValida` no acepta](2026-09-13-tipo-invalidez-desalineado.md) | [#41](https://github.com/Ghekkin/Reto-Banorte-hack-mty/issues/41) | resuelto (`a4134cd`) |
| 2026-09-13 | media | web | [`pantalla.ts` copia los alias que manda el modelo a la prop real pero no los borra, y el schema estricto rechaza el sobrante](2026-09-13-alias-de-props-sin-borrar.md) | [#42](https://github.com/Ghekkin/Reto-Banorte-hack-mty/issues/42) | resuelto (`4f00835`) |
| 2026-09-13 | alta | web | [El schema de entrada de `pintar_pantalla` rechaza componentes sin `id` antes de que el host los normalice: un paso extra en el primer turno del guion](2026-09-13-entrada-pintar-pantalla-demasiado-estricta.md) | [#43](https://github.com/Ghekkin/Reto-Banorte-hack-mty/issues/43) | resuelto (`108e722`) |
| 2026-09-13 | media | web | [«¿Cómo va mi plan de pago?» después de aplicar el plan contesta con texto y no pinta pantalla](2026-09-13-como-va-mi-plan-responde-sin-pantalla.md) | [#44](https://github.com/Ghekkin/Reto-Banorte-hack-mty/issues/44) | resuelto (`12ac74e`) |
| 2026-09-13 | media | mcp | [«La meta para diciembre»: `proyectar_ahorro` dice $32,000 al mes en el aviso y $16,000 en el escenario](2026-09-13-meta-para-diciembre-aviso-contra-escenario.md) | [#45](https://github.com/Ghekkin/Reto-Banorte-hack-mty/issues/45) | resuelto (`d9840cc`) |
| 2026-09-13 | baja | web | [`quitarPropsNoDeclaradas` deja `salud` en `Conclusion` porque se parece a `saludo`, y la pantalla se rechaza una vez](2026-09-13-prop-parecida-no-se-quita.md) | [#46](https://github.com/Ghekkin/Reto-Banorte-hack-mty/issues/46) | resuelto (`95c6f8b`) |