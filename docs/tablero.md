...
| demo | parlack | Arreglado: **la consola no pintaba nada** (registro del renderer vacío en el lienzo) + tope al canal de fallos; viaje de Beto verificado con llave, ida y vuelta. Antes: ensayo completo del guion contra producción, los 5 pasos pasan (issue #9 abierto) | sáb 09:40 |
