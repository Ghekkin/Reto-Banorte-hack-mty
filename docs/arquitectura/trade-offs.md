...
|---|---|---|---|---|---|
| **Modelo** | **Gemini 3.1 Flash Lite** vía el AI SDK; Claude Sonnet 5 cableado como respaldo con `MODELO=claude` | Opus 5 (6–8× el costo); Sonnet 5 como principal | Costo del hack ~$40; latencia baja; ecosistema natal de A2UI | Menos juicio en decisiones de interfaz. **Medido con Gemini 3.8 Flash** (modelo anterior, pendiente remedir con Flash Lite): turnos entre 2.9 s y 10.5 s, y el de 10.5 s es el primero de Beto, con dos tools | 0005 |
