...
- [La pantalla Más](como-funciona/pantalla-mas.md) — el perfil con datos de `banorte.usuarios`, las tres personas para cambiar con un toque, cómo funciona Maya en tres pasos, preguntas sugeridas por persona y el menú honesto de lo que no está en el prototipo
