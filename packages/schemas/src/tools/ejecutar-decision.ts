 ...
 * que trae el `action` de la interfaz es exactamente uno de estos cuatro.
 *
...
export const SalidaEjecutarDecision = z.object({
  ...
  resultadoAccion: z.union([SalidaAplicarPlanPago, SalidaCrearApartado, SalidaCancelarSuscripcion, SalidaCrearTopeGasto]),
  estadoPosterior: z
    .union([SalidaConsultarPlan, SalidaProyectarAhorro, SalidaDetectarFugas])
    .nullable()
    .describe(
